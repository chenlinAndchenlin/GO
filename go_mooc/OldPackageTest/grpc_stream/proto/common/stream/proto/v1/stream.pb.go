...
type StreamResData struct {
	...
	Data string `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"` //服务端发送出去的数据
}
...
type StreamReqData struct {
	...
	Data string `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"` //客户端发送出去的数据
}
...
var file_stream_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71,
...
var file_stream_proto_goTypes = []interface{}{
	(*StreamResData)(nil), // 0: StreamResData
	(*StreamReqData)(nil), // 1: StreamReqData
}
var file_stream_proto_depIdxs = []int32{
	1, // 0: Greeter.GetStream:input_type -> StreamReqData
	1, // 1: Greeter.PutStream:input_type -> StreamReqData
	1, // 2: Greeter.AllStream:input_type -> StreamReqData
	0, // 3: Greeter.GetStream:output_type -> StreamResData
	0, // 4: Greeter.PutStream:output_type -> StreamResData
	0, // 5: Greeter.AllStream:output_type -> StreamResData
