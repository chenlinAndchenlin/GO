...
func (x *BidiStreamResponse) Reset() {
	*x = BidiStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bj38_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BidiStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_bj38_proto_rawDescGZIP(), []int{7}
}
...
var file_proto_bj38_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x62, 0x6a, 0x33, 0x38, 0x22, 0x21, 0x0a, 0x0b, 0x43, 0x61, 0x6c, 0x6c,
	...
	0x32, 0x94, 0x02, 0x0a, 0x04, 0x42, 0x6a, 0x33, 0x38, 0x12, 0x2f, 0x0a, 0x04, 0x43, 0x61, 0x6c,
	0x6c, 0x12, 0x11, 0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x43, 0x61, 0x6c, 0x6c,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x0c, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x19, 0x2e, 0x62, 0x6a, 0x33,
	0x38, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x43, 0x6c, 0x69,
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x19, 0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1a, 0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74,
	...
	0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x42, 0x69, 0x64, 0x69, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x62, 0x6a, 0x33, 0x38, 0x2e, 0x42,
	...
	0x74, 0x6f, 0x3b, 0x62, 0x6a, 0x33, 0x38, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_bj38_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_bj38_proto_goTypes = []interface{}{
	(*CallRequest)(nil),          // 0: bj38.CallRequest
	(*CallResponse)(nil),         // 1: bj38.CallResponse
	(*ClientStreamRequest)(nil),  // 2: bj38.ClientStreamRequest
	(*ClientStreamResponse)(nil), // 3: bj38.ClientStreamResponse
	(*ServerStreamRequest)(nil),  // 4: bj38.ServerStreamRequest
	(*ServerStreamResponse)(nil), // 5: bj38.ServerStreamResponse
	(*BidiStreamRequest)(nil),    // 6: bj38.BidiStreamRequest
	(*BidiStreamResponse)(nil),   // 7: bj38.BidiStreamResponse
}
var file_proto_bj38_proto_depIdxs = []int32{
	0, // 0: bj38.Bj38.Call:input_type -> bj38.CallRequest
	2, // 1: bj38.Bj38.ClientStream:input_type -> bj38.ClientStreamRequest
	4, // 2: bj38.Bj38.ServerStream:input_type -> bj38.ServerStreamRequest
	6, // 3: bj38.Bj38.BidiStream:input_type -> bj38.BidiStreamRequest
	1, // 4: bj38.Bj38.Call:output_type -> bj38.CallResponse
	3, // 5: bj38.Bj38.ClientStream:output_type -> bj38.ClientStreamResponse
	5, // 6: bj38.Bj38.ServerStream:output_type -> bj38.ServerStreamResponse
	7, // 7: bj38.Bj38.BidiStream:output_type -> bj38.BidiStreamResponse
...
func file_proto_bj38_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_bj38_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
